...
const Footer: React.FC = () => {
  return (
    <footer className="py-24 px-8 bg-background border-t border-primary/5">
      <div className="max-w-[1200px] mx-auto text-center">
        ...
        <p className="text-secondary mb-12 max-w-xl mx-auto leading-relaxed">
          人类负责<span className="text-primary font-medium">顶层设计</span>，AI负责<span className="text-primary font-medium">工程落地</span>。
        </p>
