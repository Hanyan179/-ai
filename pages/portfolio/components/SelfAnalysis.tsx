  ...
  return (
    <SectionWrapper className="bg-background">
      <div className="mb-12">
        ...
        <h2 className="text-4xl font-bold text-primary tracking-tight mb-4">自我画像：对照选拔标准</h2>
          ...
          return (
            <div key={index} className="bento-card p-8 rounded-2xl group hover:bg-surfaceHighlight transition-colors duration-300">
              <div className="flex items-center space-x-4 mb-6">
                ...
                <h3 className="text-lg font-bold text-primary">{item.key}</h3>
              </div>
              
              <div className="mb-3">
                <span className="text-sm font-semibold text-primary/90 border-b border-accent/30 pb-1">
                  {item.title}
                </span>
              </div>
      ...
      <div className="mt-8 p-6 rounded-2xl border border-primary/5 bg-primary/5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
         <div>
            <div className="text-xs text-secondary uppercase tracking-wider mb-1">Recent Achievement / 近期成果</div>
            <div className="text-primary font-medium">个人知识库构建 & 公司知识图谱AI开发实战</div>
         </div>
