    ...
    <SectionWrapper className="bg-background">
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <h2 className="text-4xl font-bold text-primary tracking-tight mb-8">{PAIN_POINTS_DATA.title}</h2>
        ...
        <div className="lg:sticky lg:top-32">
            <div className="bento-card p-8 rounded-3xl border-t-4 border-t-danger/50">
                <div className="flex items-center space-x-3 mb-8 border-b border-primary/5 pb-6">
                    <BrainCircuit className="text-danger w-6 h-6" />
                    <h3 className="text-lg font-bold text-primary">工程能力退化风险</h3>
                </div>
                ...
                <div className="space-y-6">
                    <div className="bg-surfaceHighlight/30 p-4 rounded-xl">
                        ...
                        <div className="text-primary font-medium">程序化逻辑 & 架构设计</div>
                    ...
                    <div className="bg-danger/10 p-4 rounded-xl border border-danger/20">
                        ...
                        <div className="text-primary font-medium">"保姆式" Prompt 定制</div>
