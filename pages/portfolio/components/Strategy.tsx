  ...
  return (
    <SectionWrapper className="bg-background">
      <div className="max-w-3xl mb-12">
        ...
        <h2 className="text-4xl font-bold text-primary tracking-tight mb-4">{STRATEGY_DATA.title}</h2>
      ...
      <div className="space-y-6">
        ...
        <div className="bento-card p-8 rounded-3xl relative overflow-hidden">
             <div className="grid md:grid-cols-2 gap-12 relative z-10">
                <div className="flex flex-col justify-center">
                    <h3 className="text-2xl font-bold text-primary mb-4">{STRATEGY_DATA.analogy.title}</h3>
                    <p className="text-secondary leading-relaxed">
                        {STRATEGY_DATA.analogy.desc}
                    </p>
                </div>
                
                <div className="bg-surfaceHighlight/30 rounded-2xl p-6 border border-primary/5">
                    {/* Item 1: Engine */}
                    <div className="flex items-center justify-between mb-6 pb-6 border-b border-primary/5">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                <div className="text-primary font-semibold">Engine (Models)</div>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                <div className="text-primary font-semibold">Fuel (Data Assets)</div>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
            ...
            <div className="bento-card p-8 rounded-3xl flex flex-col justify-between">
                <div>
                    <div className="flex items-center space-x-3 mb-6">
                        ...
                        <h3 className="text-xl font-bold text-primary">{STRATEGY_DATA.databricks.title}</h3>
                    </div>
                    ...
                    <div className="space-y-4 mb-6">
                        ...
                        <div className="flex items-start">
                            ...
                            <span className="text-primary text-sm flex-1">{STRATEGY_DATA.databricks.solution}</span>
                        </div>
                    </div>
                </div>
            ...
            {/* Moat */}
            <div className="bento-card p-8 rounded-3xl bg-gradient-to-br from-surface to-surfaceHighlight border-primary/5 flex flex-col justify-center">
                <h3 className="text-xl font-bold text-primary mb-4">{STRATEGY_DATA.moat.title}</h3>
                <p className="text-secondary text-sm leading-relaxed mb-6">
                    {STRATEGY_DATA.moat.content}
                </p>
                <div className="flex gap-2">
                    <span className="inline-block px-3 py-1 bg-primary/5 border border-primary/10 rounded-full text-xs font-medium text-secondary">
