...
export const PERSONAL_PROJECTS: ProjectItem[] = [
  {
    ...
    category: "全栈项目",
    title: "垂直领域内容生态平台",
    description: "一套完整的内容生态系统，包含前台与后台管理。\n\n> 测试环境，未开启 CDN 加速，部分资源可能加载较慢。",
  ...
  },
  {
    ...
    category: "快速交付",
    title: "3小时极速全栈交付",
    description: "从零代码开发到上线的全过程：AI 辅助编码完成前端页面与逻辑，Docker/Nginx 完成域名解析与 SSL 配置。\n\n目的是快速构建合规的企业级官网，通过 Google/AWS 初创公司审核，申请到了**数千美金的 AI 算力补贴（Credits）**用于个人研发。",
  ...
  },
  {
    ...
    description: "零 Swift 基础，利用 AI 辅助独立构建的一套完整产品，包含 **6 个子项目**：\n\n**1. iOS 客户端** — SwiftUI 原生应用\n**2. 后端服务** — API 与业务逻辑\n**3. Mac 桌面端** — 原生 macOS 管理工具\n**4. 文档站** — 项目技术文档\n**5. 官网** — 产品介绍页面\n**6. 浏览器插件** — Chrome 扩展",
    techStack: ["Swift 5", "SwiftUI", "macOS Native", "Chrome Extension", "Docs Site"],
    metrics: [
      { label: "子项目数", value: "6 个" },
