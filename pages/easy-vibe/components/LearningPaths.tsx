  ...
  return (
    <SectionWrapper id="learning-paths">
      <div className="flex flex-col items-center text-center mb-16">
        ...
        <h2 className="text-5xl md:text-6xl font-bold text-primary mb-6">选择你的起点</h2>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-4 md:w-72 shrink-0">
                ...
                <div>
                  <div className="font-bold text-lg text-primary">{path.title}</div>
                  <div className="text-secondary text-xs mt-1">适合：{path.audience}</div>
                </div>
              </div>
              <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  <div className="text-secondary/60 text-xs mb-1">学什�?/div>
              ...
              <div className="shrink-0">
                <ChevronRight size={18} className="text-secondary/30 group-hover:text-primary transition-colors" />
              </div>
            </motion.button>
          );
        })}
