  ...
  return (
    <SectionWrapper>
      <div className="flex flex-col items-center text-center mb-16">
        ...
        <h2 className="text-5xl md:text-6xl font-bold text-primary mb-6">最新动�?/h2>
      ...
      <div className="relative max-w-3xl mx-auto">
        ...
        {!showAll && NEWS_ITEMS.length > 5 && (
          <button
            ...
            className="mt-6 mx-auto flex items-center gap-2 px-4 py-2 rounded-lg bg-primary/5 border border-primary/10 text-secondary hover:text-primary hover:bg-primary/10 transition-all text-sm"
          >
            查看更多
            <ChevronDown size={14} />
          </button>
